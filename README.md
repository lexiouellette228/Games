...
- **Avoid the legit fish (blue)** — they represent safe, normal messages or senders.
...
- Recognize and avoid password mistakes (“1234,” “password,” birthdays, names)
...
- For each scenario, the player must choose between:
  - Share → Safe to give out information.
  - Shield → Keep your information private.
- Immediate feedback is given after each choice to explain why it’s correct or incorrect.
...
- **How it works:**
  ...
  - When all matches are placed, you win and get a celebratory message! 🎉
